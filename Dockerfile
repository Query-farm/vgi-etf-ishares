...
#
# Single image serving BOTH transports of the vgi-etf-ishares worker:
...
ARG SOURCE_URL=https://github.com/Query-farm/vgi-etf-ishares

LABEL org.opencontainers.image.title="vgi-etf-ishares" \
      org.opencontainers.image.description="iShares (BlackRock) US ETF data as a VGI worker for DuckDB/SQL (stdio + HTTP)" \
